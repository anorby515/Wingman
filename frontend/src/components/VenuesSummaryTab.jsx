...
// ── Festival card ─────────────────────────────────────────────────────────────
function FestivalCard({ name, url, paused }) {
  return (
    <div className={`card p-4 flex items-center gap-3 ${paused ? 'opacity-50' : ''}`}>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 min-w-0">
          {url ? (
            <a
...
export default function VenuesSummaryTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ── Festivals ── */}
      <section>
        <SectionHeading count={festivals.length}>Festivals</SectionHeading>
        <div className="grid sm:grid-cols-2 gap-3">
